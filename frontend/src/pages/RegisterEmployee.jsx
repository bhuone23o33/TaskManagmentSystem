...
import { registerEmployee, resetManager } from '../features/manager/managerSlice.js';
...
function RegisterEmployee() {
    ...
    const { isLoadingManager, isErrorManager, isEmployeeRegistered, messageManager } = useSelector(state => state.manager);
    ...
    useEffect(() => {
        ...
        dispatch(resetManager());
    }, [isErrorManager, isEmployeeRegistered, navigate, dispatch, messageManager])
        ...
        <>
            <div className="min-h-screen h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="bg-white shadow-md rounded-lg p-8 max-w-md  space-y-8">
                    <h1 className="text-2xl font-bold text-center">Register Employee</h1>
